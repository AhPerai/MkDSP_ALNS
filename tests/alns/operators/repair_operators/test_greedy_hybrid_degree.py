...
@pytest.mark.parametrize("operator_class", [GreedyHybridDegreeOperator])
...
from algorithms.heuristics.greedy_hybrid_v2 import calc_weight
...
def test_update_state_consistency(iterations):
    ...
    main_op = GreedyHybridDegreeOperator(GREEDY_ALPHA)
